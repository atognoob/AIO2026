...
<div align="center">
  <img src="image1.1.png" alt="Dữ liệu thực được chuyển thành biểu diễn số cho AI" width="500">
...
<div align="center">
  <img src="image1.2.png" alt="Python là ngôn ngữ trung gian giữa tư duy và máy tính" width="500">
...
<div align="center">
  <img src="image2.1.png" alt="AI cần được nhìn dưới dạng bức tranh tổng thể" width="300">
</div>
...
<div align="center">
  <img src="image2.2.png" alt="Lộ trình học AI theo tầng từ nền tảng đến ứng dụng" width="500">
...
<div align="center">
  <img src="image3.1.png" alt="Google Colab là môi trường Python trực tuyến" width="500">
...
<div align="center">
  <img src="image3.2.png" alt="VSCode và PyCharm là IDE phổ biến cho Python" width="640">
  <p><em>VSCode</em></p>
</div>
...
6.1.  `List` là cấu trúc dữ liệu linh hoạt nhất của Python được sử dụng để lưu trữ các tập hợp có thứ tự cụ thể.
...
- **Có thứ tự (Ordered)**:  
  Các phần tử có vị trí xác định và luôn giữ nguyên thứ tự đó

- **Bất biến (Immutable)**:  
  Không thể thêm, xóa hoặc sửa phần tử sau khi tạo

- **Cho phép trùng lặp (Allow Duplicates)**:  
  Có thể chứa các giá trị trùng nhau

- **Đa kiểu dữ liệu (Heterogeneous)**:  
  Có thể lưu trữ nhiều kiểu dữ liệu khác nhau trong cùng một tuple

- **Cú pháp (Syntax)**:  
  Được tạo bằng dấu ngoặc tròn `()`
...
- **Không có thứ tự (Unordered)**:  
  Các phần tử không có vị trí cố định, thứ tự hiển thị có thể thay đổi

- **Có thể thay đổi (Mutable)**:  
  Có thể thêm hoặc xóa phần tử sau khi tạo

- **Không cho phép trùng lặp (No Duplicates)**:  
  Các giá trị trùng nhau sẽ tự động bị loại bỏ

- **Kiểm tra tồn tại rất nhanh (Fast Membership Testing)**:  
  Thời gian trung bình là **O(1)**

- **Cú pháp (Syntax)**:  
  Được tạo bằng dấu ngoặc nhọn `{}` hoặc hàm `set()`
...
<div align="center">
  <img src="image3.3.png" alt="Ngăn xếp công nghệ AI từ Python đến Deep Learning" width="500">
